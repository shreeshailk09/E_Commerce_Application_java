...
useEffect(()=>{
  ...
  const data={
    category: (param.levelThree || '').split('_').pop().toLowerCase(),
    colors:colorValue || [],
    sizes:sizeValue || [],
    minPrice,
    maxPrice,
...
dispatch(findProducts(data))
        ...
        <main className="mx-auto  px-4 sm:px-6 lg:px-20">
          ...
          <section aria-labelledby="products-heading" className="pt-6 pb-24">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              {/* Filters */}
              <div>
                <div className="py-10 justify-between flex items-center">
                  <h2 className="text-black font-bold opacity-50">Filters</h2>
                  <FilterListIcon />
                </div>
  ...
  {product.products && product.products?.content?.map((item) => (
    <ProductCard  product={item} />
          ...
          <section className="width-full px-3.6rem">
